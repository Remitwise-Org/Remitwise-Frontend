...
export default function EmergencyTransferCard({
  ...
  return (
    <div className="max-w-3xl mx-auto bg-red-900/10 backdrop-blur-sm border-2 border-red-900/30 rounded-3xl p-8 sm:p-10 mb-8 relative overflow-hidden shadow-2xl">
