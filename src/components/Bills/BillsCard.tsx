...
import { Bill } from "@/lib/mockdata/bills";
...
function StatusBadge({ status }: { status: Bill["status"] }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 rounded-[10px] border px-2 py-0.5 text-xs font-semibold ${s.dueBg} ${s.dueBorder} text-white`}
